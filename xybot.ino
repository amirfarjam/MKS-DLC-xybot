...
void stepperMoveA(int dir)
{
  //Serial.print('A');Serial.println(dir);
  if(dir>0){
    stpA.dWrite1(HIGH);//LOW
  }else{
    stpA.dWrite1(LOW);//HIGH
  }
  stpA.dWrite2(LOW);//HIGH
  stpA.dWrite2(HIGH);//LOW
}
...
void stepperMoveB(int dir)
{
  //Serial.print('B');Serial.println(dir);
  if(dir>0){
    stpB.dWrite1(HIGH);//LOW
  }else{
    stpB.dWrite1(LOW);//HIGH
  }
  stpB.dWrite2(LOW);//HIGH
  stpB.dWrite2(HIGH);//LOW
}
